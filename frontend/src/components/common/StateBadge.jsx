const STATE_CONFIG = {
  ...
  INVESTIGATING:         { bg: 'rgba(129,140,248,0.1)', text: '#818cf8', border: 'rgba(129,140,248,0.2)', bgLight: 'rgba(129,140,248,0.1)', textLight: '#818cf8', borderLight: 'rgba(129,140,248,0.2)' },
  ...
  VERIFYING:             { bg: 'rgba(34,211,238,0.1)',  text: '#22d3ee', border: 'rgba(34,211,238,0.2)', bgLight: 'rgba(34,211,238,0.1)', textLight: '#22d3ee', borderLight: 'rgba(34,211,238,0.2)' },
  RESOLVED:              { bg: 'rgba(52,211,153,0.1)',  text: '#34d399', border: 'rgba(52,211,153,0.2)', bgLight: 'rgba(52,211,153,0.1)', textLight: '#34d399', borderLight: 'rgba(52,211,153,0.2)' },
  FAILED_ANALYSIS:       { bg: 'rgba(251,113,133,0.1)', text: '#fb7185', border: 'rgba(251,113,133,0.2)', bgLight: 'rgba(251,113,133,0.1)', textLight: '#fb7185', borderLight: 'rgba(251,113,133,0.2)' },
  FAILED_EXECUTION:      { bg: 'rgba(251,113,133,0.1)', text: '#fb7185', border: 'rgba(251,113,133,0.2)', bgLight: 'rgba(251,113,133,0.1)', textLight: '#fb7185', borderLight: 'rgba(251,113,133,0.2)' },
  FAILED_VERIFICATION:   { bg: 'rgba(251,113,133,0.1)', text: '#fb7185', border: 'rgba(251,113,133,0.2)', bgLight: 'rgba(251,113,133,0.1)', textLight: '#fb7185', borderLight: 'rgba(251,113,133,0.2)' },
}
