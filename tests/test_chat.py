...
from airex_core.schemas.chat import ChatRequest, ChatResponse, ChatMessage
from airex_core.llm.prompts import build_chat_messages, CHAT_SYSTEM_PROMPT
...
class TestChatServiceHistory:
    ...
    async def test_get_empty_history(self):
        from airex_core.services.chat_service import get_conversation_history
    ...
    async def test_save_history(self):
        from airex_core.services.chat_service import (
...
class TestChatServiceBuildContext:
    ...
    def test_builds_basic_context(self):
        from airex_core.services.chat_service import _build_incident_context
...
class TestChatServiceChatWithIncident:
    ...
    async def test_incident_not_found_raises(self):
        from airex_core.services.chat_service import chat_with_incident
    ...
    async def test_llm_failure_raises_runtime_error(self):
        ...
        with patch("airex_core.services.chat_service.llm_client") as mock_llm:
