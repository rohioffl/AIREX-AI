...
from airex_core.services.incident_embedding_service import build_incident_summary
...
class TestBuildIncidentSummary:
    ...
    def test_truncates_when_exceeding_limit(self, monkeypatch):
        monkeypatch.setattr(
            "airex_core.services.incident_embedding_service.settings.RAG_INCIDENT_SUMMARY_MAX_CHARS",
            10,
        )
        incident = _make_incident()
