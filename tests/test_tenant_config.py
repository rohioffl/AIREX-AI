...
from airex_core.cloud.tag_parser import parse_tags
from airex_core.cloud.discovery import DiscoveredInstance
...
class TestTagParserEnrichment:
    ...
    def test_tags_fill_cloud_from_config(self):
        ...
        # This test uses the real config file at services/airex-core/config/tenants.yaml
