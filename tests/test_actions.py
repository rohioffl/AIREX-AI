...
from airex_core.actions.registry import ACTION_REGISTRY, get_action
from airex_core.actions.base import BaseAction, ActionResult
...
class TestActionPolicyAlignment:
    def test_all_registry_actions_have_policies(self):
        from airex_core.core.policy import ACTION_POLICIES
    ...
    def test_all_actions_in_llm_prompt(self):
        from airex_core.llm.prompts import SYSTEM_PROMPT
        for name in ALL_ACTION_NAMES:
