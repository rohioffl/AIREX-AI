...
from airex_core.cloud.diagnostics import get_diagnostic_commands
...
class CloudInvestigation(BaseInvestigation):
    ...
    async def investigate(self, incident_meta: dict) -> InvestigationResult:
        ...
        raw_output = "\n".join(sections)
        from airex_core.investigations.evidence_optimizer import optimize_evidence_output
    ...
    async def _get_aws_instance_zone(
        ...
        from airex_core.cloud.aws_ssh import get_instance_availability_zone
    ...
    async def _run_aws_ec2_connect_ssh(
        ...
        from airex_core.cloud.aws_ssh import aws_ec2_connect_run_command
    ...
    async def _run_gcp_ssh(
        ...
        try:
            from airex_core.cloud.gcp_ssh import gcp_ssh_run_command
    ...
    async def _resolve_gcp_ip(self, instance_name: str, project: str, zone: str) -> str:
        ...
        try:
            from airex_core.cloud.gcp_ssh import gcp_resolve_private_ip
    ...
    async def _query_gcp_logs(
        ...
        try:
            from airex_core.cloud.gcp_logging import query_gcp_logs
    ...
    async def _query_aws_logs(
        ...
        try:
            from airex_core.cloud.aws_logs import query_cloudwatch_logs
