...
from app.cloud.ssh_user_resolver import (
    _GCP_IMAGE_USER_MAP,
    _AWS_AMI_USER_MAP,
...
class TestResolveSSHUser:
    ...
    async def test_static_config_takes_priority(self):
        ...
        try:
            ...
            with patch(
                "app.cloud.tenant_config.get_ssh_user_for_host",
                return_value="admin",
            ) as mock_lookup:
    ...
    async def test_cache_hit_skips_cloud_api(self):
        ...
        with patch("app.cloud.ssh_user_resolver._detect_gcp_ssh_user") as mock_detect:
            user = await resolve_ssh_user(
                cloud="gcp",
                private_ip="",
    ...
    async def test_gcp_auto_detection_called(self):
        ...
        with patch(
            "app.cloud.ssh_user_resolver._detect_gcp_ssh_user",
    ...
    async def test_aws_auto_detection_called(self):
        ...
        with patch(
            "app.cloud.ssh_user_resolver._detect_aws_ssh_user",
            new_callable=AsyncMock,
    ...
    async def test_fallback_to_settings(self):
        ...
        with patch(
            ...
            with patch("app.cloud.ssh_user_resolver.settings") as mock_settings:
