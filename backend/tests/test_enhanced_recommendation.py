...
from app.llm.client import _parse_recommendation
...
class TestActionDescriptions:
    ...
    def test_dynamic_prompt_includes_descriptions(self):
        from app.llm.prompts import _build_action_descriptions
...
class TestSerializeRecommendation:
    def test_converts_enums(self):
        from app.services.recommendation_service import _serialize_recommendation
