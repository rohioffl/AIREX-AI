...
from app.services.runbook_generator import (
...
class TestStoreRunbook:
    ...
    async def test_stores_chunks_with_embeddings(self):
        ...
        with patch("app.services.runbook_generator.EmbeddingsClient") as MockEmbed:
...
class TestGenerateAndStoreRunbook:
    ...
    async def test_full_pipeline_success(self):
        ...
        with patch("app.services.runbook_generator.generate_runbook_content",
                    new_callable=AsyncMock) as mock_gen, \
             patch("app.services.runbook_generator.store_runbook",
