...
sys.path.insert(0, str(__file__).replace("/scripts/test_ssm.py", ""))
...
def main():
    ...
    parser.add_argument("--region", default="", help="AWS region (default: auto-discover)")
