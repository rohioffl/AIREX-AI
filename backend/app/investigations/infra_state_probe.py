...
class InfraStateProbe(BaseInvestigation):
    ...
    async def _query_aws_asg(
        ...
        try:
            from app.cloud.aws_autoscaling import query_asg_status
    ...
    async def _query_aws_vpc_flows(
        ...
        try:
            from app.cloud.aws_vpc_flows import query_vpc_flow_logs
    ...
    async def _query_gcp_mig(
        ...
        try:
            from app.cloud.gcp_mig import query_mig_status
    ...
    async def _query_gcp_vpc_flows(
        ...
        try:
            from app.cloud.gcp_vpc_flows import query_gcp_vpc_flow_logs
